...
public class RefreshLayout extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
    ...
    /**
     * 完成分页加载，没有更多数据了【不需要分页】
     */
    public void completePageData() {
        completePageData(getContext().getString(R.string.foot_state_complete));
    }
     ...
     * @param message
     */
    public void completePageData(String message){
        setLoading(false);
        iscompleteLoading=true;
        mListViewFooter.setVisibility(View.VISIBLE);
        mListView.addFooterView(mListViewFooter);

        mListViewFooter.findViewById(R.id.pull_to_refresh_load_progress).setVisibility(View.GONE);
        TextView textView = (TextView) mListViewFooter.findViewById(R.id.pull_to_refresh_loadmore_text);
